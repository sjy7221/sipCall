...
public class UAS implements SipServerTransportUser {
    ...
    public void messageReceived(SipMessage sipMessage) throws SipUriSyntaxException {
    ...
    private void requestReceived(SipRequest sipRequest) throws SipUriSyntaxException {
        //TODO 8.2
